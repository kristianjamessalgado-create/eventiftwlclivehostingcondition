...
>
    <div class="adm-dash-panel__shell">
        ...
        <header class="adm-dash-panel__hero">
            ...
            <div class="adm-dash-panel__hero-text">
                ...
                <p class="adm-dash-panel__subtitle mb-0">
                    Approve or reject email-verified registrations. Super Admin accounts are not shown.
                </p>
            </div>
        </header>
        ...
        <?php if (!empty($allUsers)): ?>
            <div class="adm-all-users-filters d-flex flex-wrap gap-2 align-items-center mb-3">
                <input type="search" id="admUserSearch" class="form-control form-control-sm" placeholder="Search name or email" autocomplete="off" style="max-width: 220px;">
                <select id="admUserRoleFilter" class="form-select form-select-sm" style="max-width: 170px;">
                ...
                <select id="admUserStatusFilter" class="form-select form-select-sm" style="max-width: 170px;">
                    ...
                    <tbody>
                        <?php foreach ($allUsers as $acc): ?>
                            ...
                            <tr class="adm-user-row"
                                ...
                                <td><span class="badge bg-secondary"><?= htmlspecialchars(ucfirst($accRole)) ?></span></td>
                                <td class="small">
