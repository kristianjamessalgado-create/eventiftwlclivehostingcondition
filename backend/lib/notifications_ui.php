...
function eventify_notification_visual(string $type): array
{
    ...
    $map = [
        ...
        'event_published' => ['icon' => 'fa-calendar-plus', 'accent' => 'success', 'label' => 'New event'],
        'event_assigned_published' => ['icon' => 'fa-user-check', 'accent' => 'success', 'label' => 'Assigned'],
        'event_reminder' => ['icon' => 'fa-bell', 'accent' => 'warning', 'label' => 'Reminder'],
        'activity_reminder' => ['icon' => 'fa-stopwatch', 'accent' => 'warning', 'label' => 'Activity'],
        ...
        'admin_announcement' => ['icon' => 'fa-bullhorn', 'accent' => 'primary', 'label' => 'Announcement'],
