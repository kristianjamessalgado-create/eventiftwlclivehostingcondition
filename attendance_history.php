...
<head>
    ...
    <title>My attendance | EVENTIFY</title>
    ...
    <header class="eah-topbar">
        ...
        <div class="eah-topbar__actions">
            ...
            <a class="eah-topbar__action is-active" href="<?= ah_h($pageUrl) ?>" aria-current="page">
                <i class="fas fa-clipboard-check me-1" aria-hidden="true"></i><span class="d-none d-sm-inline">Attendance</span>
            </a>
        </div>
    </header>
    ...
    <div class="eah-hub-panel">
        <div class="eah-event-hero">
            <div class="eah-event-hero__body">
                <p class="eah-event-hero__eyebrow">Full list</p>
                <h1 class="eah-event-hero__title">My attendance</h1>
                <p class="eah-event-hero__meta">
                    <?php if ($counts['total'] > 0): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <span>Every event and activity you checked into with QR — filter by type below</span>
                    <?php endif; ?>
                </p>
            </div>
        </div>
        ...
        <?php if ($items === []): ?>
            <div class="eah-empty">
                ...
                <div class="eah-empty-actions">
                    <button type="button" class="eah-btn eah-btn-primary" data-bs-toggle="modal" data-bs-target="#scanQRModal">
